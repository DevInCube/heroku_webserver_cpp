 ...
 */
void cerror2(FILE *stream, const char *cause, const char *errno2,
...
int webserver_run(int port)
{
   ...
   */
    ...
    while (1)
    {
        ...
        {
            cerror2(stream, method, "501", "Not Implemented",
        ...
        {
            cerror2(stream, filename, "404", "Not found",
        ...
        else
        {
            ...
            {
                cerror2(stream, filename, "403", "Forbidden",
         ...
         childfd socket descriptor */
            ...
            {                     /* child  process*/
                ...
                char * const argvb[] = {NULL};
                char * const * argv = argvb;
